...
MAGIC=16903            # this was found by internet scrounging
MY_P=${P/-/_}          # mkl_2020.3.279
MY_PV=$(ver_rs 2 '-')  # 2020.3-279
...
#conda-intel-openmp-linux-32-shadow-package-19.1.2-279-19.1.2-279.x86_64.rpm
#conda-mkl-devel-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-include-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-static-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-tbb-devel-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-tbb-linux-32-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#mkl-core-c-32bit-2020.3-279-2020.3-279.x86_64.rpm | empty
#mkl-core-f-32bit-2020.3-279-2020.3-279.x86_64.rpm | empty
#mkl-core-ps-32bit-2020.3-279-2020.3-279.x86_64.rpm | some prebuilt benchmark executables
#mkl-gnu-c-32bit-2020.3-279-2020.3-279.x86_64.rpm | empty
INTEL_DIST_X86_RPMS=(
	mkl-core-32bit
	mkl-core-rt-32bit
	mkl-f95-32bit
	...
	mkl-tbb-32bit
	mkl-tbb-rt
	intel-openmp-32bit-19.1.2-279-19.1.2-279.x86_64.rpm
)
#conda-index-tool-19.1.2-279-19.1.2-279.x86_64.rpm
#conda-intel-openmp-linux-64-shadow-package-19.1.2-279-19.1.2-279.x86_64.rpm
#conda-mkl-devel-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-include-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-mkl-static-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-tbb-devel-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
#conda-tbb-linux-64-shadow-package-2020.3-279-2020.3-279.x86_64.rpm
INTEL_DIST_AMD64_RPMS=(
	...
	mkl-tbb
	mkl-tbb-rt
	intel-openmp-19.1.2-279-19.1.2-279.x86_64.rpm
)
INTEL_DIST_DAT_RPMS=(
	mkl-common-c
	mkl-common-f
...
#mkl-pgi-c-2020.3-279-2020.3-279.x86_64.rpm | empty
#mkl-gnu-c-2020.3-279-2020.3-279.x86_64.rpm | empty
#mkl-core-c-2020.3-279-2020.3-279.x86_64.rpm | empty
#mkl-core-f-2020.3-279-2020.3-279.x86_64.rpm | empty
...
# mkl-common-c-ps-2020.3-279-2020.3-279.noarch.rpm | contained in common-c-2020xxx...
...
multilib_src_install() {
	...
	local pc_files=( $(find ${S}/rpm -name "*.pc") )
	insinto /usr/$(get_libdir)/pkgconfig
	for pc in "${pc_files[@]}" ; do
		doins "${pc}"
		# at what point should we just make our own...
		sed -e "/^prefix=/s/^.*$/prefix=${EROOT}\/usr/" \
		    -e "s|^includedir.*$|includedir=\${prefix}/include|" \
		    -e "s:/lib/:/$(get_libdir)/:g" \
		    -e "/^libdir/d" \
		    -e "/^omplibdir/d" \
		    -e "s:-L\${omplibdir}::" \
		    -e "s:\${MKLROOT}:\${prefix}:g" \
		    -e "s:-L\${prefix}.*intel64::" \
